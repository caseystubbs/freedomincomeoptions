...
def run_scanner():
    opportunities = []
    print(f"--- FREEDOM SCANNER v9.1 (UTF-8 FIX) ---")
    print(f"Scanning {len(WATCHLIST)} stocks. Please wait...")
    ...
    if not opportunities:
        print("⚠️ No trades found. Check internet connection or try during market hours.")
        top_picks = []
        rest_picks = []
    else:
    ...
    <body>
    <div class="container">
        <h1>Freedom Income Profit Hunter</h1>
    ...
    print(f"Open 'view_results.html' to see your Best Trades.")
